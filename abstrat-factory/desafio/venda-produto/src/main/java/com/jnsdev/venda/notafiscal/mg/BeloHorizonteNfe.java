package com.jnsdev.venda.notafiscal.mg;
 ...
 * @Created 02/01/2022 - 17:21
 */
public class BeloHorizonteNfe implements NFe {

    private BigDecimal aliquota = new BigDecimal("0.15");
    ...
    public void gerar(Produto produto, double imposto) {
        System.out.println("Emissão da Nota Fiscal para o estado de Minas Gerais");
        System.out.println("----------------------------------------------------");
